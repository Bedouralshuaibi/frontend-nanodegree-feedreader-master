 ...
 * since some of these tests may require DOM elements, must
...
$(function() {
    ...
    */
    describe('RSS Feeds', function() {
         ...
         * in the allFeeds object to ensures it has a URL defined
    ...
    /*  a new test suite named "Initial Entries" */
       describe('Initial Entries', function(){
        ...
        /*  below a test that ensures when the loadFeed
         * function is called and completes its work, there is at least
         * a single .entry element within the .feed container.
         * So, keep in mind loadFeed() is asynchronous, that means it requires
       ...
       it('should be an entry within the feed container', function(){
       ...
       describe('New Feed Selection', function(){
         ...
         */
         beforeEach(function(done){
           ...
           it('The content of the new feed should be change',function(){
